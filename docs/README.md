# Identify SDK V3 — Dokümantasyon

## Kılavuzlar

| Kılavuz | Açıklama |
|---------|----------|
| [Hızlı Başlangıç](../README.md) | SDK kurulumu, başlatma ve ilk entegrasyon |
| [Bağımlılıklar ve Uyumluluk](dependencies.md) | Build gereksinimleri, transitive bağımlılıklar, versiyon çakışmaları |
| [Yapılandırma Referansı](sdk-config.md) | `SdkConfig.Builder`'daki tüm ayarlar (zaman aşımları, geri tuşu, belge tipi, güvenlik vb.) |
